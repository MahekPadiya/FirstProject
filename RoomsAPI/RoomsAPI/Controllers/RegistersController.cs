  ...
  public class RegistersController : ApiController
    {
        ...
        //[ResponseType(typeof(Register))]
        /*public IHttpActionResult GetRegister(string email)
        {
            Register register = db.Registers.Find(email);
            if (register == null)
            {
                return NotFound();
            }
        ...
        public IHttpActionResult PostRegister(Register register)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = register.RegiId }, register);
        }
        ...
        {
            return db.Registers.Count(e => e.RegiId == id) > 0;
        }
    }
}
